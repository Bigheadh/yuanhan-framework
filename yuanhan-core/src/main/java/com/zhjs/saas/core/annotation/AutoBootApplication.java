...
public @interface AutoBootApplication
{
	 ...
	 * Allows for more concise annotation declarations e.g.: {@code @ServletComponentScan("com.yuanhan.pkg")} or
	 * {@code @ServletComponentScan(basePackages="com.yuanhan.pkg")}.
