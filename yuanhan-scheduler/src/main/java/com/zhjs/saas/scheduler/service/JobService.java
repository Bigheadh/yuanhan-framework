package com.yuanhan.yuanhan.scheduler.service;
...
import com.yuanhan.yuanhan.scheduler.Job;
import com.yuanhan.yuanhan.scheduler.config.JobConfParser;
...
public class JobService
{
	...
	public void addJob(Job job) {
        ...
        // 任务执行日志数据源，以名称获取
        if (StringUtil.isNotBlank(job.getEventTraceRdbDataSource())) {
